            ...
            <div id="login_page">
                <div style="margin-top: 15%;">
                    <div class="card mx-auto form-group col-5">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center; margin-bottom: 10%;">Admin Login</h3>
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" id="form_uname" name="username" value="admin@gmail.com">
                                <span class="error_form" id="uname_error_message"></span>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-sm-13 form-group">
                                    <input type="password" class="form-control mt-2" placeholder="Password" id="form_pass" name="password" value="admin123">
                                ...
                                <button type="submit" class="btn btn-primary mx-auto form-control" style="width: 25%; margin-top: 5%; background-image: linear-gradient(90deg, #020024 0%, #090979 35%, #00d4ff 100%);">Login</button>
                            </div>
                        </div>
                    </div>
                </div>
